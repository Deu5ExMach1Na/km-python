...
def get_all_videos(page,perpage,vlist):
  ...
  headers={'Host': 'ekb4jn2sdt.com','sec-ch-ua': '"Not?A_Brand";v="8", "Chromium";v="108", "Microsoft Edge";v="108"','Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8','User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36 Edg/108.0.1462.46'}
  ...
  text=json_handler.handle(crypto.decrypt(r.text)).replace(' ','')
